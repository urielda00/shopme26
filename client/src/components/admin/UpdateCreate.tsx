...
const UpdateCreate: FC<UpdateCreateProps> = ({ isUpdate, isCreate }) => {
	...
	useEffect(() => {
		...
		const timer = setTimeout(async () => {
			try {
				...
				setSearchResults([]);
				setSearchError(error?.response?.data?.message || "Failed to search products");
			} finally {
	...
	const loadProductIntoForm = async (productId: string) => {
		try {
			...
			setSearchError(error?.response?.data?.message || error?.message || "Failed to load product");
		} finally {
	...
	useEffect(() => {
		if (!isUpdate || !preselectedProductId) return;
									...
									return (
										...
										>
											...
											<Mui.Stack direction="row" spacing={1}>
												<Mui.Button
													variant="outlined"
													startIcon={busy ? undefined : <EditOutlinedIcon />}
							...
							<Mui.Grid container spacing={2}>
								<Mui.Grid item xs={12}>
									<Mui.TextField
										...
										id="productName"
										label="Product Name"
										InputLabelProps={{ shrink: Boolean(watch("productName")) }}
								...
								<Mui.Grid item xs={12}>
									<Mui.TextField
										...
										InputLabelProps={{ shrink: Boolean(watch("shortDescription")) }}
								...
								<Mui.Grid item xs={12}>
									<Mui.TextField
										...
										InputLabelProps={{ shrink: Boolean(watch("longDescription")) }}
										multiline
										minRows={4}
							...
							<Mui.Grid container spacing={2}>
								<Mui.Grid item xs={12} sm={4}>
									<Mui.TextField
										fullWidth
										label="Quantity"
										InputLabelProps={{ shrink: Boolean(watch("quantity")) }}
										type="number"
										{...register("quantity", {
											valueAsNumber: true,
								...
								<Mui.Grid item xs={12} sm={4}>
									<Mui.TextField
										fullWidth
										label="Release Year"
										InputLabelProps={{ shrink: Boolean(watch("releaseYear")) }}
										type="number"
							...
							<Mui.Grid container spacing={2}>
								<Mui.Grid item xs={12} sm={6}>
									<Mui.TextField
										fullWidth
										label="Company"
										InputLabelProps={{ shrink: Boolean(watch("company")) }}
										id="company"
										type="text"
										{...register("company", {
								...
								<Mui.Grid item xs={12} sm={6}>
									<Mui.TextField
										...
										InputLabelProps={{ shrink: Boolean(watch("os")) }}
										id="os"
										type="text"
										{...register("os", {
								...
								<Mui.Grid item xs={12} sm={6}>
									<Mui.TextField
										fullWidth
										label="Brand"
										InputLabelProps={{ shrink: Boolean(watch("brand")) }}
										id="brand"
										type="text"
										{...register("brand", {
								...
								<Mui.Grid item xs={12} sm={6}>
									<Mui.TextField
										fullWidth
										label="Category"
										InputLabelProps={{ shrink: Boolean(watch("category")) }}
										id="category"
										type="text"
										{...register("category", {
